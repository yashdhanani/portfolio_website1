...
import { GrCode, GrMysql, GrVirtualMachine } from "react-icons/gr";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<IoLogoPython />} name={"Python"} value={90} />
                <ProgressBar logo={<SiMysql />} name={"SQL"} value={88} />
                <ProgressBar
                  logo={<SiPandas/>}
                  name={"Pandas"}
                  value={80}
                />
                <ProgressBar logo={<SiPowerbi />} name={"Statistics"} value={90} />
                <ProgressBar
                  logo={<GrVirtualMachine />}
